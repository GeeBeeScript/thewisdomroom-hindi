    ...
    <section className="w-full flex flex-col items-start">
      <div className="w-full flex flex-col justify-between items-start mb-3">
        <p className="w-full flex gap-3 font-bold text-[1.2rem] text-[#333]">
          <span className="">सवाल / टिप्पणियां</span>{" "}
      ...
      <div className="w-full flex flex-col gap-5 items-start sm:px-5 my-2">
        <AlertDialog open={isOpen} onOpenChange={setIsOpen}>
          <AlertDialogContent>
            <AlertDialogHeader>
              <AlertDialogTitle>टिप्पणी जोड़ने के लिए लॉगिन करें</AlertDialogTitle>
              <AlertDialogDescription>
                टिप्पणी करने के लिए जल्दी से लॉगिन करें या रजिस्टर करें
              </AlertDialogDescription>
            </AlertDialogHeader>
            <AlertDialogFooter>
