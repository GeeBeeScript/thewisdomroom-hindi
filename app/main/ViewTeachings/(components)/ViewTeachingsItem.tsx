...
interface ViewTeachingsItemProps {
  id: string;
  title: string;
  description: string;
  mainContent: string;
...
const ViewTeachingsItem = ({ id, title, description, mainContent, bannerColour }: ViewTeachingsItemProps) => {
  return (
    <Card
      className="
        relative snap-start
    ...
    >
      ...
      <CardFooter className="w-full">
        <Button className="w-full">
          <Link href={`/main/ViewTeachings/${id}`} className="w-full">शिक्षा खोलें / पढ़ें</Link>
        </Button>
      </CardFooter>
    </Card>
  );
...
export default ViewTeachingsItem;