    ...
    >
      ...
      >
        ...
        <div className="flex-1 overflow-y-auto py-4 px-6">
          <p className="text-sm font-medium text-gray-500 mb-3 pl-1">जाएं</p>
          <nav className="flex flex-col space-y-1">
            {[
              { href: "/main/Interpretations", label: "व्याख्या देखें" },
              { href: "/main/Questions", label: "सवाल देखें" },
              { href: "/main/AskAQuestion", label: "सवाल पूछें" },
              { href: "/main/ViewTeachings", label: "शिक्षाएं देखें" },
            ].map((item) => (
              <Link
                key={item.href}
                href={item.href}
